...
function Home() {
  ...
  function timeConvert(num) {
    ...
    return (
      hours + ":" + (minutes > 9 ? "" + minutes : "0" + minutes) + " " + amPm
    );
  }
    ...
    <div className="container">
      <section className="s1">
        <div className="sub-container">
          <header>
            <Link to="/">
              <p id="logo">Sleep Tracker🌙</p>
            </Link>
            <nav id="menu">
              <ul>
                <li>
                  <Link to="/">
                    <p id="def" className="li-btn li-btn-active">
                      Tracker
                    </p>
                  </Link>
                </li>
      ...
      <section className="s2">
        <div className="sub-container time-grid">
          ...
          <form className="card">
            <h3 style={{ color: "black", textAlign: "center" }}>I Want to</h3>
            <div className="time">
              <button
                className="btn li-btn btn-active wake"
                onClick={wakeHandler}
                type="button"
              >
                WakeUp At
            ...
            />
            <button onClick={resultHandler} className="btn btn-submit">
              Get Sleep Time
            </button>
          </form>
        </div>
      ...
      <section className="s4">
        <div className="sub-container like-grid">
          <div className="like-card">
            <p>
              If You Find This Helpful Then Encourage Creator By Dropping ❤️
            </p>
            <div className="links">
              <p>
                <a href="https://instagram.com/hitchhicker.tech">
                  <i className="fa fa-instagram" aria-hidden="true"></i>{" "}
                  Instagram
                </a>
              </p>
              <p>
                <a href="https://www.linkedin.com/in/parthpanchal8401/">
                  {" "}
                  <i className="fa fa-linkedin" aria-hidden="true"></i> LinkedIn
                </a>
              </p>
              <p>
                <a href="https://github.com/hitchhicker007">
                  {" "}
